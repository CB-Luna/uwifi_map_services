...
class FinalPopupSuccess extends StatelessWidget {
  const FinalPopupSuccess({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () => Restart.restartApp(webOrigin: '/uwifi_map_services-build/'),
                child: Text(
                  'Close',
