...
class AdditionalTabsMobile extends StatelessWidget {
  final String idTV;
  const AdditionalTabsMobile({Key? key, required this.idTV}) : super(key: key);
                ...
                SizedBox(
                    ...
                    child: Padding(
                        ...
                        child: TabBar(
                            ...
                            tabs: [
                              Tab(child: Text("Video Streams", style: style, textAlign: TextAlign.center)),
                              Tab(child: Text("Recording Storage", style: style, textAlign: TextAlign.center)),
                            ]))),
                const Divider(
                  thickness: 2,
