...
class CustomListTilePortabilityF extends StatelessWidget {
  final Place place;
  final SearchControllerPortabilityR controller;
  const CustomListTilePortabilityF({
    Key? key,
    required this.place,
  ...
  Widget build(BuildContext context) {
    ...
    final RegExpMatch? match =
        regex.firstMatch(controller.addressController.text);
