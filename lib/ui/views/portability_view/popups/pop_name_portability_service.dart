...
class PopNamePortabilityService extends StatelessWidget {
  const PopNamePortabilityService({Key? key}) : super(key: key);
                  ...
                  RichText(
                    text: TextSpan( 
                      ...
                      children: [
                        ...
                        TextSpan(text: "'${portabilityFormProvider.portFirstName} ${portabilityFormProvider.portLastName}' ", 
                          style: GoogleFonts.poppins(
                          fontSize: mobile ? 18 : 25,
                          height: 1,
                          color: const Color(0xff001E4D),
                        ...
                        const TextSpan(text: 'the same name that appears on your current telephone bill?'),
                      ],
                    ),
                    textAlign: TextAlign.center,
                  ),
                Center(
                  child: Wrap(
                    ...
                    children: [
                      ...
                      CustomOutlinedButton(
                            onPressed: () {
                              selectorSummaryController.changeView(3);
                            },
                            text: 'No',
