...
class PortabilityTitleContract extends StatelessWidget {
  const PortabilityTitleContract({Key? key}) : super(key: key);
      ...
      child: Column(
        children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          selectorSummaryController.changePortabilityMobileView(0);
                        }
                      ),
                    ),
          ...
          FittedBox(
            ...
            fit: BoxFit.contain,
            child: Text(
              'Portability Authorization Letter Info',
